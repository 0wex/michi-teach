...
import pixelCatBall from './assets/pixel-cat-ball.gif';
    ...
    <footer class="composer-area">
      ...
      <form class="composer" id="composer">
        ...
        <div class="composer-field">
          <img class="composer-cat" src="${pixelCatBall}" alt="" width="32" height="24" aria-hidden="true" />
...
document.querySelector('.composer-field')?.addEventListener('click', () => input.focus());
